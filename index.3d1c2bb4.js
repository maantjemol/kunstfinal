 ...
 */ !function(n, e) {
    ...
    function G(n19, e9) {
        var t11;
        return n19.tweens.map(function(r9) {
            ...
            }(r9, e9), o = a7.value, u = i1.arr(o) ? o[1] : o, c = C1(u), s = A(e9.target, n19.name, c, e9), f = t11 ? t11.to.original : s, l = i1.arr(o) ? o[0] : f, d = C1(l) || C1(s), p = c || d;
    ...
    function en(t12) {
        void 0 === t12 && (t12 = {});
        var r10, o4 = 0, u3 = 0, i4 = 0, c2 = 0, s2 = null;
        function f3(n27) {
        ...
        function x2() {
            var n28 = M.direction;
            "alternate" !== n28 && (M.direction = "normal" !== n28 ? "normal" : "reverse"), M.reversed = !M.reversed, r10.forEach(function(n) {
        ...
        function B(n29) {
            ...
            M.progress = a1(d / e14 * 100, 0, 100), M.reversePlayback = d < M.currentTime, r10 && function(n) {
                if (M.reversePlayback) for(var e = c2; e--;)P2(n, r10[e]);
                else for(var t = 0; t < c2; t++)P2(n, r10[t]);
        ...
        return M.reset = function() {
            var n = M.direction;
            M.passThrough = !1, M.currentTime = 0, M.progress = 0, M.paused = !0, M.began = !1, M.loopBegan = !1, M.changeBegan = !1, M.completed = !1, M.changeCompleted = !1, M.reversePlayback = !1, M.reversed = "reverse" === n, M.remaining = M.loop, r10 = M.children;
            for(var e = c2 = r10.length; e--;)M.children[e].reset();
    ...
    }, en.stagger = function(n31, e15) {
        void 0 === e15 && (e15 = {});
        var t = e15.direction || "normal", r = e15.easing ? h1(e15.easing) : null, a = e15.grid, o = e15.axis, u = e15.from || 0, c = "first" === u, s = "center" === u, f = "last" === u, l = i1.arr(n31), d = l ? parseFloat(n31[0]) : parseFloat(n31), p = l ? parseFloat(n31[1]) : 0, v = C1(l ? n31[1] : n31) || 0, g = e15.start || 0 + (l ? d : 0), m = [], y = 0;
...
//# sourceMappingURL=index.3d1c2bb4.js.map
